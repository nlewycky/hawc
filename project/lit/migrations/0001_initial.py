    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_text_url', utils.models.CustomURLField(blank=True, help_text='Link to full-text publication (may require increased access privileges, only reviewers and team-members)')),
        ...
        migrations.AddField(
            ...
            name='search',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lit.Search'),
        ),
