    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noel_name', models.PositiveSmallIntegerField(choices=[(0, 'NOEL/LOEL'), (1, 'NOAEL/LOAEL')], default=assessment.models.Assessment.get_noel_name_default, help_text='What term should be used to refer to NOEL/NOAEL and LOEL/LOAEL?', verbose_name='NOEL/NOAEL name')),
                ('rob_name', models.PositiveSmallIntegerField(choices=[(0, 'Risk of bias'), (1, 'Study evaluation')], default=assessment.models.Assessment.get_rob_name_default, help_text='What term should be used to refer to risk of bias/study evaluation questions?', verbose_name='Risk of bias/Study evaluation name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assessment.Species')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('assessment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='assessment.Assessment')),
                ('effects', models.ManyToManyField(blank=True, to='assessment.EffectTag', verbose_name='Tags')),
            ],
        ),
        migrations.CreateModel(
            name='Attachment',
